...
export default function RegisterClientPage() {
  ...
  const inputClass = (field: string) =>
    `w-full px-4 py-3 bg-white/8 border border-white/15 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/25 transition-all duration-300`;
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-2xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white mb-2">Inscription Client</h1>
            <p className="text-white/80">Créez votre compte pour organiser vos événements</p>
          </div>
