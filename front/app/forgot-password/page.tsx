        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/8 backdrop-blur-xl border border-white/15 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-white/75 mt-2">Pas de problème, nous vous enverrons les instructions</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/8 border border-white/15 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/25 transition-all duration-300"
