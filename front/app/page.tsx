      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Your all-in-one platform for managing events, connecting with people, and creating unforgettable experiences.
          </p>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">Easy Planning</h3>
            <p className="text-gray-600">
              Create and manage events effortlessly with our intuitive interface and powerful tools.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">Connect People</h3>
            <p className="text-gray-600">
              Bring people together and build meaningful connections through amazing events.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition">
            ...
            <p className="text-gray-600">
              Monitor your events with real-time analytics and insights to improve every time.
            </p>
          </div>
        </div>
      </main>
